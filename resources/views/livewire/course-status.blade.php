    ...
    <div class="container grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
            ...
            <div class="flex items-center mt-4 cursor-pointer" wire:click="completed">
                ...
                @endif
                <p class="ml-2 text-sm">Marcar esta lección como culminada</p>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="flex items-center">
                    <figure>
                        <img class="rounded-full h-12 w-12 object-cover mr-4 shadow"
                                        ...
                                        <div>
                                            @if($lesson->completed)
                                                ...
                                                @if($current->id == $lesson->id)
                                                    <span
                                                        class="inline-block h-4 w-4 border-2 border-yellow-300 rounded-full mr-2 mt-1"></span>
                                                @else
                                                    <span
                                                        class="inline-block h-4 w-4 bg-yellow-300 rounded-full mr-2 mt-1"></span>
                                                @endif
                                            ...
                                            @else
                                                ...
                                                @if($current->id == $lesson->id)
                                                    <span
                                                        class="inline-block h-4 w-4 border-2 border-gray-500 rounded-full mr-2 mt-1"></span>
                                                @else
                                                    <span
                                                        class="inline-block h-4 w-4 bg-gray-500 rounded-full mr-2 mt-1"></span>
                                                @endif
