<div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex">
            ...
            <div class="relative" x-data="{open: false}">
                <button x-on:click="open = !open"
                        class="px-4 text-gray-700 block h-12 rounded-lg overflow-hidden focus:outline-none bg-white shadow h-12 px-4 rounded-lg text-gray-700 mr-4">
                ...
                <div class="absolute right-0 w-40 mt-2 py-2 bg-white border rounded shadow-xl"
                    ...
                    @foreach($categories as $category)
                        <a
                            class="transition-colors cursor-pointer duration-200 block px-4 py-2 text-normal text-gray-900 rounded hover:bg-blue-500 hover:text-white"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-4 mt-4 mb-8">
        {{$courses->links()}}
    </div>
</div>
